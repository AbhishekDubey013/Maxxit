/**
 * Hyperliquid Connect - Simple 3-Step Flow
 * Works with the user wallet system (one agent per user)
 */

import { useState, useEffect } from 'react';
import { X, Wallet, Copy, Check, ExternalLink, Zap, Shield, CheckCircle, AlertCircle, Loader2 } from 'lucide-react';
