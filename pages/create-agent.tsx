      ...
      <div className="py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-transparent pb-5" data-testid="text-title">
                ...
                {steps.map((s) => {
                  ...
                  return (
                    <div key={s.number} className="flex flex-col items-center">
                      ...
                      <span
                        className={`mt-2 text-xs font-medium transition-colors hidden sm:block ${isCurrent || isCompleted ? 'text-foreground' : 'text-muted-foreground'
                          }`}
                      >
                        {s.label}
                      </span>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="bg-card border border-border rounded-lg p-8">
            ...
            {step === 4 && (
              <div className="space-y-6">
                ...
                {/* CT Accounts List - Fixed with max-height */}
                {loadingCtAccounts ? (
